...
아무튼 이 문제 오류를 발견한 뒤에, 조금 더 어렵게 꼬은 후 화학Ⅱ 내용을 일부 첨가하여 만들어낸 것이 이 문제이다. 이 문제의 시초인 170719 문제에서 내가 $(n,\:a,\:c)=(44,\:33,\:25)$ 순서쌍을 어떻게 찾았는지, 그리고 실제 문제와 옳은 풀이가 무엇인지 궁금한 사람들을 위해 자세한 내용을 하단에 pdf로 첨부해두었다. <a href="/170719_화학1_오류.pdf" target="_blank">(새 탭에서 열기)</a>
